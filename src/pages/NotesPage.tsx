...
export default function NotesPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      <div>
        <h1 className="font-serif text-2xl font-bold text-scripture-800 mb-1">Notes</h1>
      ...
      {notes.map(note => (
        ...
        >
          ...
          <p className="font-serif text-gray-500 text-xs italic">{truncate(note.verseText, 120)}</p>
          ...
          {editingId === note.id ? (
            <div className="space-y-2">
              <textarea
                ...
                className="w-full min-h-[80px] text-sm border border-gray-300 rounded p-2 focus:outline-none focus:ring-2 focus:ring-scripture-400 resize-y"
              />
